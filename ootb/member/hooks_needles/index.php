...
<?php
 ...
 if (isset($_GET['Filter'])) {
    ...
    if ($_GET['brand']=="all" AND $_GET['category']=="all") {
        # code...
        header("Location:http://localhost/ootb/member/hooks_needles/");
    }
 }
  ?>
<head>
            ...
            <div class="panel panel-info">
              ...
              <div class="panel-heading">
                <div class="row">
                      ...
                      <div class="col-sm-4"><a href="http://localhost/ootb/member/hooks_needles/" class="btn btn-xs btn-success pull-right"><span class="glyphicon glyphicon-refresh"></span></a></div>
...
<script type="text/javascript">
   ...
   $(".filteryarn").change(function(){
        ...
        $(location).attr('href','http://localhost/ootb/member/hooks_needles/?Filter&brand='+brand+'&category='+type);
