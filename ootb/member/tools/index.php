...
<?php
 ...
 if (isset($_GET['Filter'])) {
    ...
    if ($_GET['brand']=="all") {
        # code...
        header("Location:http://localhost/ootb/member/tools/");
    }
 }
  ?>
<head>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
       <ul class="nav navbar-nav">
        ...
        <li class="bg-danger"><a href="#">Tools</a></li>
...
<div class="row">
            ...
            <div class="panel panel-danger">
              ...
              <div class="panel-heading">
                <div class="row">
                      ...
                      <div class="col-sm-4"><a href="http://localhost/ootb/member/tools/" class="btn btn-xs btn-success pull-right"><span class="glyphicon glyphicon-refresh"></span></a></div>
  ...
  <?php
                       if (isset($_GET['Filter'])) {
                        ...
                        $prodlist = mysqli_query($con,"SELECT * FROM `ootb_tools` WHERE product_brand LIKE'%$pbrand%'");

                    }else{
                            $prodlist = mysqli_query($con,"SELECT * FROM `ootb_tools`");
                    }
...
<script type="text/javascript">
   ...
   $(".filteryarn").change(function(){
        ...
        $(location).attr('href','http://localhost/ootb/member/tools/?Filter&brand='+brand);
