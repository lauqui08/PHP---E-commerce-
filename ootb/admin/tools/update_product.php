...
$query = mysqli_query($con,"UPDATE `ootb_tools` SET `product_name`='$pname',`product_brand`='$pbrand',`product_details`='$pdetails',`product_quantity`='$pquantity',`product_price`='$pprice',`product_image`='$pimage' WHERE `product_sku` = '$sku'");
