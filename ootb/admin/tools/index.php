...
<?php
 ...
 if (isset($_GET['Filter'])) {
    ...
    if ($_GET['brand']=="all") {
        # code...
        header("Location:http://localhost/ootb/admin/tools/");
    }
 }
  ?>
<head>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="bg-warning"><a href="#">Tools</a></li>
            ...
            <div class="panel panel-warning">
              ...
              <div class="panel-heading">
                <div class="row">
                      ...
                      <div class="col-sm-4"><a href="http://localhost/ootb/admin/tools/" class="btn btn-xs btn-success pull-right"><span class="glyphicon glyphicon-refresh"></span></a></div>
    ...
    <div class="col-sm-10">
      <div class="panel panel-warning">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <button type="button" class="btn btn-default pull-right" data-toggle="modal" data-target="#myModal3" data-backdrop="static"><span class="glyphicon glyphicon-plus-sign"></span> Add Tools</button>
            </div>
        </div>
            ...
            <tr>
              ...
              <th>Image</th>
                    ...
                    if (isset($_GET['Filter'])) {
                        ...
                        $typequery = mysqli_query($con,"SELECT * FROM `ootb_tools` WHERE product_brand LIKE'%$pbrand%'");

                    }else{
                            $typequery = mysqli_query($con,"SELECT * FROM `ootb_tools`");
                    }
  ...
  <div class="modal fade" id="myModaledit" role="dialog">
    <div class="modal-dialog">
      ...
      <script type="text/javascript">
        ...
        $(location).attr('href', 'http://localhost/ootb/admin/tools/?Filter&brand='+brand);
