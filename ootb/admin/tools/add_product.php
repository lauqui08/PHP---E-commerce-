...
if (isset($_POST['submit'])) {
	...
	$query = mysqli_query($con,"INSERT INTO `ootb_tools`(`product_id`, `product_sku`, `product_name`,`product_brand`, `product_details`, `product_quantity`, `product_price`, `product_image`) VALUES ('','$sku','$pname','$pbrand','$pdetails','$pquantity','$pprice','$pimage')");
