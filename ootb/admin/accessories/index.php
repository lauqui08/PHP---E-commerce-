...
<?php
 ...
 if (isset($_GET['Filter'])) {
    ...
    if ($_GET['brand']=="all") {
        # code...
        header("Location:http://localhost/ootb/admin/accessories/");
    }
 }
  ?>
<head>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="bg-success"><a href="#">Accessories</a></li>
            ...
            <div class="panel panel-success">
              ...
              <div class="panel-heading">
                <div class="row">
                      ...
                      <div class="col-sm-4"><a href="http://localhost/ootb/admin/accessories/" class="btn btn-xs btn-success pull-right"><span class="glyphicon glyphicon-refresh"></span></a></div>
    ...
    <div class="col-sm-10">
      <div class="panel panel-success">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <button type="button" class="btn btn-default pull-right" data-toggle="modal" data-target="#myModal3" data-backdrop="static"><span class="glyphicon glyphicon-plus-sign"></span> Add Accessories</button>
            </div>
        </div>
            ...
            <tr>
              ...
              <th>Image</th>
                    ...
                    if (isset($_GET['Filter'])) {
                        ...
                        $typequery = mysqli_query($con,"SELECT * FROM `ootb_accessories` WHERE product_brand LIKE'%$pbrand%'");

                    }else{
                            $typequery = mysqli_query($con,"SELECT * FROM `ootb_accessories`");
                    }
                            
                            while ($row = mysqli_fetch_assoc($typequery)) { ?>
                            <tr data-toggle="modal" data-target="#myModaledit" class="medit" data-backdrop="static"
                             data-id="<?php echo $row['product_id']; ?>" data-sku="<?php echo $row['product_sku']; ?>" data-name="<?php echo $row['product_name']; ?>" data-brand="<?php echo $row['product_brand']; ?>" data-price="<?php echo $row['product_price']; ?>" data-quantity="<?php echo $row['product_quantity']; ?>" data-details="<?php echo $row['product_details']; ?>" data-image="<?php echo $row['product_image']; ?>">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title">Add New Accessories</h4>
        </div>
  ...
  <div class="modal fade" id="myModaledit" role="dialog">
    <div class="modal-dialog">
      ...
      <script type="text/javascript">
        ...
        $(location).attr('href', 'http://localhost/ootb/admin/accessories/?Filter&brand='+brand);
