...
$query = mysqli_query($con,"UPDATE `ootb_hooks_and_needles` SET `product_name`='$pname',`product_category`='$pstyle',`product_brand`='$pbrand',`product_details`='$pdetails',`product_quantity`='$pquantity',`product_price`='$pprice',`product_image`='$pimage' WHERE `product_sku` = '$sku'");
