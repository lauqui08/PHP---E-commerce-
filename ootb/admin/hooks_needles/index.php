...
<?php
 ...
 if (isset($_GET['Filter'])) {
    ...
    if ($_GET['brand']=="all" AND $_GET['category']=="all") {
        # code...
        header("Location:http://localhost/ootb/admin/hooks_needles/");
    }
 }
  ?>
<head>
            ...
            <div class="panel panel-info">
              ...
              <div class="panel-heading">
                <div class="row">
                      ...
                      <div class="col-sm-4"><a href="http://localhost/ootb/admin/hooks_needles/" class="btn btn-xs btn-success pull-right"><span class="glyphicon glyphicon-refresh"></span></a></div>
...
<!--FILTER LIST END........................................................................................................................................-->
    <div class="col-sm-10">
      <div class="panel panel-info">
        ...
        <div class="row">
            <div class="col-sm-6">
               <h5>HOOKS AND NEEDLES</h5>
            </div>
            <div class="col-sm-6">
                <button type="button" class="btn btn-default pull-right" data-toggle="modal" data-target="#myModal3" data-backdrop="static"><span class="glyphicon glyphicon-plus-sign"></span> Add Hooks and Needles</button>
            </div>
        </div>
            ...
            <tr>
              ...
              <th>Image</th>
                    ...
                    if (isset($_GET['Filter'])) {
                        ...
                        $typequery = mysqli_query($con,"SELECT * FROM `ootb_hooks_and_needles` WHERE product_brand LIKE'%$pbrand%' AND product_category LIKE'%$ptype%'");

                    }else{
                            $typequery = mysqli_query($con,"SELECT * FROM `ootb_hooks_and_needles`");
                    }
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title">Add Hooks and Needles</h4>
        </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9"> 
                        <select class="form-control" name="pstyle" id="pstyle" required/>
                          ...
                          <?php
                            $catquery = mysqli_query($con,"SELECT * FROM `ootb_han_category`");
  ...
  <div class="modal fade" id="myModaledit" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">×</button>
          <h4 class="modal-title">Update Hooks and Needles</h4>
        </div>
        <div class="modal-body">
      ...
      <script type="text/javascript">
        ...
        $(location).attr('href', 'http://localhost/ootb/admin/hooks_needles/?Filter&brand='+brand+'&category='+type);
