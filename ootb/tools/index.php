...
<?php
 ...
 if (isset($_GET['Filter'])) {
    ...
    if ($_GET['brand']=="all") {
        # code...
        header("Location:http://localhost/ootb/tools/");
    }
 }
  ?>
<head>
            ...
            <div class="panel panel-danger">
              ...
              <div class="panel-heading">
                <div class="row">
                      ...
                      <div class="col-sm-4"><a href="http://localhost/ootb/tools/" class="btn btn-xs btn-success pull-right"><span class="glyphicon glyphicon-refresh"></span></a></div>
...
<script type="text/javascript">
   ...
   $(".filteryarn").change(function(){
        ...
        $(location).attr('href','http://localhost/ootb/tools/?Filter&brand='+brand);
