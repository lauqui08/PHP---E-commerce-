...
<?php
 ...
 if (isset($_GET['Filter'])) {
    ...
    if ($_GET['brand']=="all") {
        # code...
        header("Location:http://localhost/ootb/accessories/");
    }
 }
  ?>
<head>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="../logout.php"><span class="glyphicon glyphicon-user"></span> Your Account</a></li>
      </ul>
    </div>
  </div>
</nav>
...
<div class="row">
            ...
            <div class="panel panel-success">
              ...
              <div class="panel-heading">
                <div class="row">
                      ...
                      <div class="col-sm-4"><a href="http://localhost/ootb/accessories/" class="btn btn-xs btn-success pull-right"><span class="glyphicon glyphicon-refresh"></span></a></div>
  ...
  <?php
                       if (isset($_GET['Filter'])) {
                        ...
                        $prodlist = mysqli_query($con,"SELECT * FROM `ootb_accessories` WHERE product_brand LIKE'%$pbrand%'");

                    }else{
                            $prodlist = mysqli_query($con,"SELECT * FROM `ootb_accessories`");
                    }
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
                <a href="" class="btn btn-info viewprod" data-toggle="modal" data-target="#myModaledit" data-backdrop="static"
                             data-id="<?php echo $row['product_id']; ?>" data-sku="<?php echo $row['product_sku']; ?>" data-name="<?php echo $row['product_name']; ?>" data-brand="<?php echo $row['product_brand']; ?>" data-price="<?php echo $row['product_price']; ?>" data-quantity="<?php echo $row['product_quantity']; ?>" data-details="<?php echo $row['product_details']; ?>" data-image="<?php echo $row['product_image']; ?>">Info...</a>
            </div>
...
<script type="text/javascript">
   ...
   $(".filteryarn").change(function(){
        ...
        $(location).attr('href','http://localhost/ootb/accessories/?Filter&brand='+brand);
