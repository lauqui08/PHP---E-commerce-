...
<?php
 ...
 if (isset($_GET['Filter'])) {
    ...
    if ($_GET['brand']=="all" AND $_GET['color']=="all" AND $_GET['type']=="all" AND $_GET['thickness']=="all") {
        # code...
        header("Location:http://localhost/ootb/yarns/");
    }
 }
  ?>
<head>
            ...
            <div class="panel panel-primary">
              ...
              <div class="panel-heading">
                <div class="row">
                      ...
                      <div class="col-sm-4"><a href="http://localhost/ootb/yarns/" class="btn btn-xs btn-success pull-right"><span class="glyphicon glyphicon-refresh"></span></a></div>
...
<script type="text/javascript">
   ...
   $(".filteryarn").change(function(){
        ...
        $(location).attr('href','http://localhost/ootb/yarns/?Filter&brand='+brand+'&type='+type+'&thickness='+thickness+'&color='+color);
